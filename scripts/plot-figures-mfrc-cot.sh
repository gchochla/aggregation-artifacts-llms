...
python scripts/annotator-pull/compare_annotator_distributions.py \
    ...
    --o logs/analysis/annotators/mfrc/annotators-gpt-3.5-cot/ \
...
python scripts/annotator-pull/compare_annotator_distributions.py \
    ...
    --o logs/analysis/annotators/mfrc/annotators-gpt-4o-cot/ \
    --alternative ann aggr prior
...
python scripts/annotator-pull/compare_annotator_distributions.py \
    ...
    --o logs/analysis/annotators/mfrc/annotators-llama-3-8b-cot/ \
    --alternative ann aggr prior
...
python scripts/annotator-pull/compare_annotator_distributions.py \
    ...
    --o logs/analysis/annotators/mfrc/annotators-llama-2-7b-cot/ \
    --alternative ann aggr prior
...
python scripts/annotator-pull/compare_annotator_distributions.py \
    ...
    --o logs/analysis/annotators/mfrc/annotators-llama-3-70b-cot/ \
    --alternative ann aggr prior
...
python scripts/annotator-pull/compare_annotator_distributions.py \
    ...
    --o logs/analysis/annotators/mfrc/annotators-llama-2-70b-cot/ \
    --alternative ann aggr prior

# calculate similarities and improvements

python scripts/annotator-pull/calculate_annotator_improvement.py \
    --annotator-results-dir logs/analysis/annotators/mfrc/annotators-gpt-3.5-cot/ \
    --output-dir logs/analysis/annotators/mfrc/annotators-gpt-3.5-cot-improvement/ --metric micro_f1

python scripts/annotator-pull/calculate_annotator_improvement.py \
    --annotator-results-dir logs/analysis/annotators/mfrc/annotators-gpt-4o-cot/ \
    --output-dir logs/analysis/annotators/mfrc/annotators-gpt-4o-cot-improvement/ --metric micro_f1

python scripts/annotator-pull/calculate_annotator_improvement.py \
    --annotator-results-dir logs/analysis/annotators/mfrc/annotators-llama-3-8b-cot/ \
    --output-dir logs/analysis/annotators/mfrc/annotators-llama-3-8b-cot-improvement/ --metric micro_f1

python scripts/annotator-pull/calculate_annotator_improvement.py \
    --annotator-results-dir logs/analysis/annotators/mfrc/annotators-llama-2-7b-cot/ \
    --output-dir logs/analysis/annotators/mfrc/annotators-llama-2-7b-cot-improvement/ --metric micro_f1

python scripts/annotator-pull/calculate_annotator_improvement.py \
    --annotator-results-dir logs/analysis/annotators/mfrc/annotators-llama-3-70b-cot/  \
    --output-dir logs/analysis/annotators/mfrc/annotators-llama-3-70b-cot-improvement/ --metric micro_f1

python scripts/annotator-pull/calculate_annotator_improvement.py \
    --annotator-results-dir logs/analysis/annotators/mfrc/annotators-llama-2-70b-cot/ \
    --output-dir logs/analysis/annotators/mfrc/annotators-llama-2-70b-cot-improvement/ --metric micro_f1

# plot improvements

# python scripts/annotator-pull/plot_improvements.py \
#     --i logs/analysis/annotators/mfrc/annotators-gpt-3.5-cot-improvement \
#     logs/analysis/annotators/mfrc/annotators-gpt-4o-cot-improvement \
#     logs/analysis/annotators/mfrc/annotators-llama-3-8b-cot-improvement \
...
#     --o logs/analysis/annotators/cot-results --type prior
